...
namespace QuickVoteNative.Imageloaders
{
    ...
    public class ImageLoader
    {
        ...
        public void DisplayImage(string url, ImageView imageView, int defaultResourceId)
        {
            ...
            if (bitmap != null)
            {
                imageView.SetImageDrawable(new CircleDrawable(bitmap));//SetImageBitmap(bitmap);
            }
            else
            {
            ...
            activity.RunOnUiThread(() =>
                {
                    ...
                    if (bitmap != null)
                        photoToLoad.ImageView.SetImageDrawable(new CircleDrawable(bitmap));//SetImageBitmap(bitmap);
                    else if(m_StubID != -1)
