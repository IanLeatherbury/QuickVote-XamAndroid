...
[assembly:MetaData("com.facebook.sdk.ApplicationName", Value = "QuickVote")]

namespace QuickVoteNative
{
    [Activity(Label = "QuickVote", MainLauncher = true, WindowSoftInputMode = SoftInput.AdjustResize)]
    public class MyLoginActivity : FragmentActivity
    {        
        ...
        const String PENDING_ACTION_BUNDLE_KEY = "quickVote.QuickVote:PendingAction";
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.login_facebook);
        ...
        private void UpdateUI()
        {
            ...
            try
            {
                ...
                profPicUri = profile.GetProfilePictureUri(200, 200);

                profPicUrl = "https:" + profPicUri.EncodedSchemeSpecificPart;

                userName = profile.FirstName + " " + profile.LastName;
            }
            catch (Exception e)
            {
                Console.WriteLine("Exception getting profile pic: " + e);
            }
            ...
            if (enableButtons && profile != null)
            {
                ...
                intent.PutExtra("imgUrl", profPicUrl);
        ...
        {
            var image = BitmapFactory.DecodeResource(this.Resources, Resource.Drawable.com_facebook_button_icon);
